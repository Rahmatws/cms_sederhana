      ...
      <form method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <small class="form-text text-muted">(Simulasi, upload gambar belum aktif)</small>
          </div>
          <div class="form-group">
            <label>Status</label>
